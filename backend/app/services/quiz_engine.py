...
class QuizEngine:
    ...
    def generate_quiz(self, user_id: int, topic: str, num_questions: int = 5, difficulty: int = None) -> models.Quiz:
        """
        ...
        if difficulty is None:
            difficulty = progress.current_difficulty if progress else 2  # Default to medium
        
        # 2. Retrieve context (topic-filtered)
        chunks = self.retriever.retrieve(
            query=f"{topic} concepts, definitions, applications, explainations, examples",
        ...
        print("LLM Output Type:", type(quiz_payload))
    ...
    def _generate_quiz_with_llm(self, context: str, difficulty: int, num_questions: int) -> dict:
        ...
        - MUST include 1 correct answer and 3 plausible distractors
